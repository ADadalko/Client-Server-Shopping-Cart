...
public:
	...
	void allKITS() {
		system("cls");
		cout << endl << "Ôףעבמכüםאÿ פמנלא" << endl;
	...
	void purchaseKITS() {
		...
		do {
			...
			case 1:
				...
				fout << "Ôמנלû " << brandNike << " - " << number << " (רע)\n";
				fout.close();
				break;
			case 2:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Ôמנלû " << brandAdidas << " - " << number << " (רע)\n";
				fout.close();
				break;
			case 3:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Ôמנלû " << brandGivova << " - " << number << " (רע)\n";
				fout.close();
				break;
			case 4:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Ôמנלû " << brandMasita << " - " << number << " (רע)\n";
				fout.close();
				break;
			case 5:
				break;
