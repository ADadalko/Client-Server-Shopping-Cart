	...
	void purchaseBAGS() {
		...
		do {
			...
			case 1:
				...
				fout << "Рюкзаки " << brandNike << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 2:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Рюкзаки " << brandAdidas << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 3:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Kempa = Kempa - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Рюкзаки " << brandKempa << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 4:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Joma = Joma - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Рюкзаки " << brandJoma << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 5:
				break;
	...
	void purchaseSOCKS() {
		...
		do {
			...
			case 1:
				...
				Nike = Nike - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Гетры " << brandNike << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 2:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Adidas = Adidas - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Гетры " << brandAdidas << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 3:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Puma = Puma - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Гетры " << brandPuma << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 4:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Joma = Joma - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Гетры " << brandJoma << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 5:
				break;
	...
	void purchasePADS() {
		...
		do {
			...
			case 1:
				...
				Nike = Nike - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Щитки " << brandNike << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 2:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Adidas = Adidas - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Щитки " << brandAdidas << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 3:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Demix = Demix - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Щитки " << brandDemix << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 4:
				recv(newConnection, (char*)&number, sizeof(number), 0);
				...
				Fora = Fora - number;
				fout.open("CHECKS.txt", ios::out | ios::app);
				fout << "Щитки " << brandFora << " - " << number << " (шт)\n";
				fout.close();
				break;
			case 5:
				break;
